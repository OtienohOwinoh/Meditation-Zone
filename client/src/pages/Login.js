...
function Login({ onLogin }) {
  ...
  <h2 className='text-center mt-4 font-weight-bold'>CALMA MEDITATION ZONE</h2>
  <div className='alert alert-info rounded-0'>Get all your Mediation lessons at the comfort of your home.</div>
       {
        showLogin
        ? (
            <>
